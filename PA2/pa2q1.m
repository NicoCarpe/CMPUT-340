...
% function would be a better choice to fit our data. Also since the data
% seems to be very noisy, it would be better to use an approximation to
% better understand the underlying trend of the data, as an interpolation
% would attempt to connect all the points.
...
x_approx = linspace(min(X), max(X), 5000);
